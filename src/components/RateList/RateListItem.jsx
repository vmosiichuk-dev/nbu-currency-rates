...
export const RateListItem = ({ rate, todayRate, rateDifference, showFullName, hideExtraColumns = false }) => {
	...
	const currencyColumnMinWidth = showFullName ? isMediaLG ? '282px' : '262px' : '102px';
